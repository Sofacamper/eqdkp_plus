 ...
 * -----------------------------------------------------------------------
 * Began:		2010
 * Date:		$Date: 2012-12-13 16:25:40 +0100 (Thu, 13 Dec 2012) $
 * -----------------------------------------------------------------------
 ...
 * @version		$Rev: 12580 $
 *
 * $Id: pdh_r_roles.class.php 12580 2012-12-13 15:25:40Z wallenium $
 */
		...
		*/
		public function init(){
			...
			while ($row = $this->db->fetch_record($roleresult)){
				...
				$this->roles[$row['role_id']]['classes']	= (substr_count($row['role_classes'], "|") > 0) ? explode("|", $row['role_classes']) : array();
