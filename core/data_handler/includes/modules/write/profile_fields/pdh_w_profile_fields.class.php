...
* -----------------------------------------------------------------------
* Began:		2010
* Date:			$Date: 2012-06-09 16:18:15 +0200 (Sat, 09 Jun 2012) $
* -----------------------------------------------------------------------
...
* @version		$Rev: 11815 $
*
* $Id: pdh_w_profile_fields.class.php 11815 2012-06-09 14:18:15Z godmod $
*/
...
if(!class_exists('pdh_w_profile_fields')) {
	class pdh_w_profile_fields extends pdh_w_generic {
		...
		public function insert_field($data=array()){
			$name = preg_replace("/[^a-zA-Z0-9_]/","",strtolower($this->in->get('language')));
