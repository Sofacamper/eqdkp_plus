...
* -----------------------------------------------------------------------
* Began:		2007
* Date:			$Date: 2012-11-01 20:49:07 +0100 (Thu, 01 Nov 2012) $
* -----------------------------------------------------------------------
...
* @version		$Rev: 12378 $
*
* $Id: zs.esys.php 12378 2012-11-01 19:49:07Z wallenium $
*/
...
$system_def = array(
	...
	'data' => array(
		'description' => registry::fetch('user')->lang('lm_layout_zs'),
		'point_direction' => 'asc',
	),
