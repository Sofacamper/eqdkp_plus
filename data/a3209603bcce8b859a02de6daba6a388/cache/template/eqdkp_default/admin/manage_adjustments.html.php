...
echo '
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="2" class="colorswitch">
		<tr>
			<th colspan="' . ((isset($this->_data['.'][0]['HPTT_COLUMN_COUNT'])) ? $this->_data['.'][0]['HPTT_COLUMN_COUNT'] : '') . '"><span style="float:left;">' . ((isset($this->_data['.'][0]['L_manadjs_title'])) ? $this->_data['.'][0]['L_manadjs_title'] : (($this->lang('manadjs_title')) ? $this->lang('manadjs_title') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'manadjs_title'))) . '         }')) . '</span><span style="float:right;"><input type="button" name="addadj" value="' . ((isset($this->_data['.'][0]['L_add_adjustment'])) ? $this->_data['.'][0]['L_add_adjustment'] : (($this->lang('add_adjustment')) ? $this->lang('add_adjustment') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'add_adjustment'))) . '         }')) . '" class="mainoption bi_new" onclick="window.location=\'manage_adjustments.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '&amp;upd=true\'"/></span></th>
		</tr>
			' . ((isset($this->_data['.'][0]['ADJ_LIST'])) ? $this->_data['.'][0]['ADJ_LIST'] : '') . '
		<tr>
			<th colspan="' . ((isset($this->_data['.'][0]['HPTT_COLUMN_COUNT'])) ? $this->_data['.'][0]['HPTT_COLUMN_COUNT'] : '') . '"><input type="button" name="del" value="' . ((isset($this->_data['.'][0]['L_delete_selected_adjs'])) ? $this->_data['.'][0]['L_delete_selected_adjs'] : (($this->lang('delete_selected_adjs')) ? $this->lang('delete_selected_adjs') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'delete_selected_adjs'))) . '         }')) . '" class="mainoption bi_delete" onclick="delete_warning();" />
