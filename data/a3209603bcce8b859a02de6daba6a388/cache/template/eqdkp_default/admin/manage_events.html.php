...
echo '
	...
	<tr>
		<th colspan="' . ((isset($this->_data['.'][0]['HPTT_COLUMN_COUNT'])) ? $this->_data['.'][0]['HPTT_COLUMN_COUNT'] : '') . '"><span style="float:left;">' . ((isset($this->_data['.'][0]['L_manevents_title'])) ? $this->_data['.'][0]['L_manevents_title'] : (($this->lang('manevents_title')) ? $this->lang('manevents_title') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'manevents_title'))) . '         }')) . '</span>
		<span style="float:right;"><input type="button" class="mainoption bi_new" name="add_event" value="' . ((isset($this->_data['.'][0]['L_addevent_title'])) ? $this->_data['.'][0]['L_addevent_title'] : (($this->lang('addevent_title')) ? $this->lang('addevent_title') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'addevent_title'))) . '         }')) . '" onclick="window.location=\'manage_events.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '&amp;upd=true\'" /></span>
		</th>
	</tr>
	<tr>
		<td colspan="' . ((isset($this->_data['.'][0]['HPTT_COLUMN_COUNT'])) ? $this->_data['.'][0]['HPTT_COLUMN_COUNT'] : '') . '" align="center" class="menu">' . ((isset($this->_data['.'][0]['EVENT_PAGINATION'])) ? $this->_data['.'][0]['EVENT_PAGINATION'] : '') . '</td>
	</tr>
		' . ((isset($this->_data['.'][0]['EVENTS_LIST'])) ? $this->_data['.'][0]['EVENTS_LIST'] : '') . '
