...
echo '
	...
	<tr>
		<th colspan="3"><span style="float:left;">' . ((isset($this->_data['.'][0]['L_menu_itempools'])) ? $this->_data['.'][0]['L_menu_itempools'] : (($this->lang('menu_itempools')) ? $this->lang('menu_itempools') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'menu_itempools'))) . '         }')) . '</span><a href="manage_itempools.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '&amp;upd=true" style="float:right;"><input type="button" name="add" value="' . ((isset($this->_data['.'][0]['L_add_itempool'])) ? $this->_data['.'][0]['L_add_itempool'] : (($this->lang('add_itempool')) ? $this->lang('add_itempool') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'add_itempool'))) . '         }')) . '" class="mainoption bi_new" /></a></th>
	</tr>
	<tr>
		<th width="16">&nbsp;</th>
		<th width="200">
			<a href="manage_itempools.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '&amp;sort=0.0" class="down_arrow_green"></a>
			<a href="manage_itempools.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '&amp;sort=0.1" class="up_arrow_green"></a>
			' . ((isset($this->_data['.'][0]['L_name'])) ? $this->_data['.'][0]['L_name'] : (($this->lang('name')) ? $this->lang('name') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'name'))) . '         }')) . '
		</th>
		<th>
			<a href="manage_itempools.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '&amp;sort=1.0" class="down_arrow_green"></a>
			<a href="manage_itempools.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '&amp;sort=1.1" class="up_arrow_green"></a>
	...
	';// BEGIN itempools
$_itempools_count = (isset($this->_data['itempools.'])) ?  sizeof($this->_data['itempools.']) : 0;
if ($_itempools_count) {
for ($_itempools_i = 0; $_itempools_i < $_itempools_count; $_itempools_i++)
{
echo '
	<tr>
		<td width="16"><a href="manage_itempools.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '&amp;upd=true&amp;id=' . ((isset($this->_data['itempools.'][$_itempools_i]['ID'])) ? $this->_data['itempools.'][$_itempools_i]['ID'] : '') . '"><img src="' . ((isset($this->_data['.'][0]['EQDKP_ROOT_PATH'])) ? $this->_data['.'][0]['EQDKP_ROOT_PATH'] : '') . 'images/glyphs/edit.png" alt="Edit" width="16" height="16" border="0" /></a></td>
		<td width="200"><a href="manage_itempools.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '&amp;upd=true&amp;id=' . ((isset($this->_data['itempools.'][$_itempools_i]['ID'])) ? $this->_data['itempools.'][$_itempools_i]['ID'] : '') . '">' . ((isset($this->_data['itempools.'][$_itempools_i]['NAME'])) ? $this->_data['itempools.'][$_itempools_i]['NAME'] : '') . '</a></td>
		<td>' . ((isset($this->_data['itempools.'][$_itempools_i]['DESC'])) ? $this->_data['itempools.'][$_itempools_i]['DESC'] : '') . '</td>
	</tr>
	';}}
// END itempools
echo '
	<tr>
		<th colspan="3" class="footer">' . ((isset($this->_data['.'][0]['ITEMPOOLS_FOOTCOUNT'])) ? $this->_data['.'][0]['ITEMPOOLS_FOOTCOUNT'] : '') . '</th>
	</tr>
</table>
';// ELSE
} else {
