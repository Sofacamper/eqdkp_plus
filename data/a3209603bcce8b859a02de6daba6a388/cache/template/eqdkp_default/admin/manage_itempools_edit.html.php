...
echo '
	...
	<fieldset class="settings">
		<legend>' . ((isset($this->_data['.'][0]['L_add_itempool'])) ? $this->_data['.'][0]['L_add_itempool'] : (($this->lang('add_itempool')) ? $this->lang('add_itempool') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'add_itempool'))) . '         }')) . '</legend>
		<dl>
			<dt><label>' . ((isset($this->_data['.'][0]['L_name'])) ? $this->_data['.'][0]['L_name'] : (($this->lang('name')) ? $this->lang('name') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'name'))) . '         }')) . ':</label></dt>
			<dd><input type="text" name="name" value="' . ((isset($this->_data['.'][0]['NAME'])) ? $this->_data['.'][0]['NAME'] : '') . '" class="input" /></dd>
		</dl>
		<dl>
			...
			<dd><input type="text" name="desc" value="' . ((isset($this->_data['.'][0]['DESC'])) ? $this->_data['.'][0]['DESC'] : '') . '" class="input" /></dd>
		</dl>
	</fieldset>
...
if ($this->_data['.'][0]['IID']) { 
echo '
	<input type="hidden" name="ip_id" value="' . ((isset($this->_data['.'][0]['IID'])) ? $this->_data['.'][0]['IID'] : '') . '" />
...
echo '
	<input type="submit" name="cancel" value="' . ((isset($this->_data['.'][0]['L_cancel'])) ? $this->_data['.'][0]['L_cancel'] : (($this->lang('cancel')) ? $this->lang('cancel') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'cancel'))) . '         }')) . '" class="mainoption bi_back" />
