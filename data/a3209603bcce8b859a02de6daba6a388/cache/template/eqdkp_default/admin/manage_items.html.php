...
echo '
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="2" class="colorswitch">
		<tr>
			<th colspan="' . ((isset($this->_data['.'][0]['HPTT_COLUMN_COUNT'])) ? $this->_data['.'][0]['HPTT_COLUMN_COUNT'] : '') . '"><span style="float:left;">' . ((isset($this->_data['.'][0]['L_manitems_title'])) ? $this->_data['.'][0]['L_manitems_title'] : (($this->lang('manitems_title')) ? $this->lang('manitems_title') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'manitems_title'))) . '         }')) . '</span><span style="float:right;"><input type="button" name="additem" value="' . ((isset($this->_data['.'][0]['L_add_item'])) ? $this->_data['.'][0]['L_add_item'] : (($this->lang('add_item')) ? $this->lang('add_item') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'add_item'))) . '         }')) . '" class="mainoption bi_new" onclick="window.location=\'manage_items.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '&amp;upd=true\'"/></span></th>
		</tr>
			' . ((isset($this->_data['.'][0]['ITEM_LIST'])) ? $this->_data['.'][0]['ITEM_LIST'] : '') . '
		<tr>
			<th colspan="' . ((isset($this->_data['.'][0]['HPTT_COLUMN_COUNT'])) ? $this->_data['.'][0]['HPTT_COLUMN_COUNT'] : '') . '">
				<input type="button" name="del" value="' . ((isset($this->_data['.'][0]['L_delete_selected_items'])) ? $this->_data['.'][0]['L_delete_selected_items'] : (($this->lang('delete_selected_items')) ? $this->lang('delete_selected_items') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'delete_selected_items'))) . '         }')) . '" class="mainoption bi_delete"  onclick="delete_warning();" />
				<input type="hidden" name="del" value="1" disabled="disabled" id="mass_del_submit" />
			</th>
		</tr>
		<tr class="pagination_row"><td colspan="' . ((isset($this->_data['.'][0]['HPTT_COLUMN_COUNT'])) ? $this->_data['.'][0]['HPTT_COLUMN_COUNT'] : '') . '" align="center">' . ((isset($this->_data['.'][0]['PAGINATION'])) ? $this->_data['.'][0]['PAGINATION'] : '') . '</td></tr>
	</table>
