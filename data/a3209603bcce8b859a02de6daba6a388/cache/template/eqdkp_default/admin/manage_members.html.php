...
echo '
	<form action=\'manage_members.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '\' method=\'post\' class="colorswitch">
<table width="100%" cellpadding="2" cellspacing="1" border="0">
	<tr>
		<th colspan="' . ((isset($this->_data['.'][0]['HPTT_COLUMN_COUNT'])) ? $this->_data['.'][0]['HPTT_COLUMN_COUNT'] : '') . '"><span style="float:left;">' . ((isset($this->_data['.'][0]['L_group_members'])) ? $this->_data['.'][0]['L_group_members'] : (($this->lang('group_members')) ? $this->lang('group_members') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'group_members'))) . '         }')) . '</span><span style="float:right;"><input type="button" name="madd" value="' . ((isset($this->_data['.'][0]['L_add_member'])) ? $this->_data['.'][0]['L_add_member'] : (($this->lang('add_member')) ? $this->lang('add_member') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'add_member'))) . '         }')) . '" class="mainoption bi_new" onclick="AddChar()"/></span></th>
	</tr>
	' . ((isset($this->_data['.'][0]['MEMBER_LIST'])) ? $this->_data['.'][0]['MEMBER_LIST'] : '') . '
	<tr>
		<th colspan="' . ((isset($this->_data['.'][0]['HPTT_COLUMN_COUNT'])) ? $this->_data['.'][0]['HPTT_COLUMN_COUNT'] : '') . '">
			<input type="button" name="mdel" value="' . ((isset($this->_data['.'][0]['L_delete_selected_members'])) ? $this->_data['.'][0]['L_delete_selected_members'] : (($this->lang('delete_selected_members')) ? $this->lang('delete_selected_members') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'delete_selected_members'))) . '         }')) . '" class="mainoption bi_delete" onclick="delete_warning();" />
			<input type="hidden" name="mdel" value="1" disabled="disabled" id="mass_del_submit" />
			<input type="submit" name="mstatus" value="' . ((isset($this->_data['.'][0]['L_mass_stat_change'])) ? $this->_data['.'][0]['L_mass_stat_change'] : (($this->lang('mass_stat_change')) ? $this->lang('mass_stat_change') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'mass_stat_change'))) . '         }')) . '" class="mainoption" />
			<input type="submit" name="rankc" value="' . ((isset($this->_data['.'][0]['L_mass_rank_change'])) ? $this->_data['.'][0]['L_mass_rank_change'] : (($this->lang('mass_rank_change')) ? $this->lang('mass_rank_change') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'mass_rank_change'))) . '         }')) . '" class="mainoption" />
			' . ((isset($this->_data['.'][0]['RANK_SEL'])) ? $this->_data['.'][0]['RANK_SEL'] : '') . '
		</th>
	</tr>
	<tr class="pagination_row">
		<td colspan="' . ((isset($this->_data['.'][0]['HPTT_COLUMN_COUNT'])) ? $this->_data['.'][0]['HPTT_COLUMN_COUNT'] : '') . '" align="center">' . ((isset($this->_data['.'][0]['PAGINATION'])) ? $this->_data['.'][0]['PAGINATION'] : '') . '</td>
	</tr>
</table>
