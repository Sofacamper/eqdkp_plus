...
echo '
	...
	<fieldset class="settings">
		<legend>' . ((isset($this->_data['.'][0]['L_Multi_addkonto'])) ? $this->_data['.'][0]['L_Multi_addkonto'] : (($this->lang('Multi_addkonto')) ? $this->lang('Multi_addkonto') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'Multi_addkonto'))) . '         }')) . '</legend>
		<dl>
			<dt><label>' . ((isset($this->_data['.'][0]['L_Multi_chooseevents'])) ? $this->_data['.'][0]['L_Multi_chooseevents'] : (($this->lang('Multi_chooseevents')) ? $this->lang('Multi_chooseevents') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'Multi_chooseevents'))) . '         }')) . ':</label></dt>
			<dd>' . ((isset($this->_data['.'][0]['EVENT_SEL'])) ? $this->_data['.'][0]['EVENT_SEL'] : '') . '</dd>
		</dl>
		<dl>
			<dt><label>' . ((isset($this->_data['.'][0]['L_Multi_eventsnoatt'])) ? $this->_data['.'][0]['L_Multi_eventsnoatt'] : (($this->lang('Multi_eventsnoatt')) ? $this->lang('Multi_eventsnoatt') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'Multi_eventsnoatt'))) . '         }')) . ':</label></dt>
			<dd>' . ((isset($this->_data['.'][0]['NO_ATT_SEL'])) ? $this->_data['.'][0]['NO_ATT_SEL'] : '') . '</dd>
		</dl>
		<dl>
			<dt><label>' . ((isset($this->_data['.'][0]['L_Multi_chooseitempools'])) ? $this->_data['.'][0]['L_Multi_chooseitempools'] : (($this->lang('Multi_chooseitempools')) ? $this->lang('Multi_chooseitempools') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'Multi_chooseitempools'))) . '         }')) . ':</label></dt>
			<dd>' . ((isset($this->_data['.'][0]['ITEMPOOL_SEL'])) ? $this->_data['.'][0]['ITEMPOOL_SEL'] : '') . '</dd>
		</dl>
		<dl>
			<dt><label>' . ((isset($this->_data['.'][0]['L_Multi_kontoname_short'])) ? $this->_data['.'][0]['L_Multi_kontoname_short'] : (($this->lang('Multi_kontoname_short')) ? $this->lang('Multi_kontoname_short') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'Multi_kontoname_short'))) . '         }')) . ':</label><br /><span>' . ((isset($this->_data['.'][0]['L_Multi_discnottolong'])) ? $this->_data['.'][0]['L_Multi_discnottolong'] : (($this->lang('Multi_discnottolong')) ? $this->lang('Multi_discnottolong') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'Multi_discnottolong'))) . '         }')) . '</span></dt>		
			<dd><input type="text" name="name" size="10" maxlength="254" value="' . ((isset($this->_data['.'][0]['NAME'])) ? $this->_data['.'][0]['NAME'] : '') . '" class="input" /></dd>
		</dl>
		<dl>
			<dt><label>' . ((isset($this->_data['.'][0]['L_description'])) ? $this->_data['.'][0]['L_description'] : (($this->lang('description')) ? $this->lang('description') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'description'))) . '         }')) . ':</label></dt>
			<dd><input type="text" name="desc" size="55" maxlength="250" value="' . ((isset($this->_data['.'][0]['DESC'])) ? $this->_data['.'][0]['DESC'] : '') . '" class="input" /></dd>
		</dl>
	</fieldset>
	...
	';// IF MDKP_ID
if ($this->_data['.'][0]['MDKP_ID']) { 
echo '
	<input type="hidden" name="mdkp_id" value="' . ((isset($this->_data['.'][0]['MDKP_ID'])) ? $this->_data['.'][0]['MDKP_ID'] : '') . '" />
	<input type="button" name="del" value="' . ((isset($this->_data['.'][0]['L_delete'])) ? $this->_data['.'][0]['L_delete'] : (($this->lang('delete')) ? $this->lang('delete') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'delete'))) . '         }')) . '" class="mainoption bi_delete" onclick="delete_warning();" />
	';// ENDIF
}
echo '
	<input type="submit" name="cancel" value="' . ((isset($this->_data['.'][0]['L_cancel'])) ? $this->_data['.'][0]['L_cancel'] : (($this->lang('cancel')) ? $this->lang('cancel') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'cancel'))) . '         }')) . '" class="liteoption bi_back" />
