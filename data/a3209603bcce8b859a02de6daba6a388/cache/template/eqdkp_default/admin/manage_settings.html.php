...
echo '
	<form method="post" action="' . ((isset($this->_data['.'][0]['ACTION'])) ? $this->_data['.'][0]['ACTION'] : '') . '" name="settings">
	<div id=\'plus_sett_tabs\'>
		<ul>
			';// BEGIN tabs
...
echo '
				<dl>
					...
					<dd>' . ((isset($this->_data['tabs.'][$_tabs_i]['fieldset.'][$_fieldset_i]['field.'][$_field_i]['FIELD'])) ? $this->_data['tabs.'][$_tabs_i]['fieldset.'][$_fieldset_i]['field.'][$_field_i]['FIELD'] : '') . '</dd>
				</dl>
				';}}
// END field
echo '
...
echo '
		...
		<div align=\'center\'>
			<input name="save_plus" type="submit" class="mainoption bi_ok" id="save" value="' . ((isset($this->_data['.'][0]['L_save'])) ? $this->_data['.'][0]['L_save'] : (($this->lang('save')) ? $this->lang('save') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'save'))) . '         }')) . '" />
			<input type="button" name="reset" value="' . ((isset($this->_data['.'][0]['L_reset'])) ? $this->_data['.'][0]['L_reset'] : (($this->lang('reset')) ? $this->lang('reset') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'reset'))) . '         }')) . '" class="liteoption bi_reset" onclick="window.location=\'manage_settings.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '\'"/>
		</div>
	</div>
