...
// IF S_MESSAGE
if ($this->_data['.'][0]['S_MESSAGE']) { 
echo '

	<div class="' . ((isset($this->_data['.'][0]['MSG_CLASS'])) ? $this->_data['.'][0]['MSG_CLASS'] : '') . ' roundbox">
		<div class="' . ((isset($this->_data['.'][0]['MSG_ICON'])) ? $this->_data['.'][0]['MSG_ICON'] : '') . '"><span><span class="bold">' . ((isset($this->_data['.'][0]['MSG_TITLE'])) ? $this->_data['.'][0]['MSG_TITLE'] : '') . '</span><br />' . ((isset($this->_data['.'][0]['MSG_TEXT'])) ? $this->_data['.'][0]['MSG_TEXT'] : '') . '</span></div>
	</div>
...
echo '
	...
	<div class="content">
		<div class="contentHead">
			' . ((isset($this->_data['.'][0]['MSG_TITLE'])) ? $this->_data['.'][0]['MSG_TITLE'] : '') . '
		</div>
		<div class="contentInner row1">
			' . ((isset($this->_data['.'][0]['MSG_TEXT'])) ? $this->_data['.'][0]['MSG_TEXT'] : '') . '
		</div>
		<div class="contentFooter">
			';// IF S_BUTTON
if ($this->_data['.'][0]['S_BUTTON']) { 
echo '' . ((isset($this->_data['.'][0]['BU_FORM'])) ? $this->_data['.'][0]['BU_FORM'] : '') . '<input type="submit" class="mainoption" ' . ((isset($this->_data['.'][0]['BU_ONCLICK'])) ? $this->_data['.'][0]['BU_ONCLICK'] : '') . ' value="' . ((isset($this->_data['.'][0]['BU_VALUE'])) ? $this->_data['.'][0]['BU_VALUE'] : '') . '">' . ((isset($this->_data['.'][0]['BU_FORM_END'])) ? $this->_data['.'][0]['BU_FORM_END'] : '') . '';// ENDIF
}
echo '
		</div>
	</div>
...
// IF S_LOGIN
if ($this->_data['.'][0]['S_LOGIN']) { 
echo '
	<br />
	';// INCLUDE login.html
$this->assign_from_include('login.html');
// ENDIF
}
// ELSE
} else {
